            ...
            <div class="container text-center py-5 des--txt">
                ...
                <div>
                    <ol class="breadcrumb justify-content-center mb-0">
                        ...
                        <li class="breadcrumb-item active text-white">Maldives</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div>
                <table id="customers">
                    ...
                    <tr>
                        ...
                        <td>90,00sq kms (1,190 islands)</td>

                    </tr>
                    <tr>
                        <td class="td1">Archipelago</td>
                        <td> Length 823 kms, Width 130 kms</td>

                    </tr>
                    <tr>
                        <td class="td1">Total number of administrative Atolls</td>
                        <td>19</td>

                    </tr>
                    <tr>
                        <td class="td1">Largest Atoll</td>
                        <td>Huvadhu (Area 6486 sq miles)</td>

                    </tr>
                    <tr>
                        <td class="td1">Island Trading</td>
                        <td>Helen Bennett</td>

                    </tr>
                    <tr>
                        <td class="td1">Smallest Atoll</td>
                        <td>Gnaviyani (Area 4.81 sq miles)</td>

                    </tr>
                    <tr>
                        <td class="td1">Geographical Location</td>
                        <td>Indian Ocean</td>

                    </tr>
                    <tr>
                        <td class="td1">Immediate Neighbors</td>
                        <td>India and Sri Lanka (Both located northeast of Maldives), Lakshadweep Islands (India) to the north, Chaos Archipelago to the south, and the Seychelles to the southwest</td>
                    ...
                    <tr>
                        ...
                        <td>3,94,999 (July 2011 estimate)</td>

                    </tr>
                    <tr>
                        <td class="td1">Capital</td>
                        <td>Male (Area 1.77 sq kms)</td>

                    </tr>
                    <tr>
                        <td class="td1">Airport</td>
                        <td> Velana International Airport on Hulule island, two kilometers east of Male</td>

                    </tr>
                    <tr>
                        <td class="td1">Maldives standard time</td>
                        <td>+5 hrs. GMT</td>

                    </tr>
                    <tr>
                        <td class="td1">International Relations</td>
                        <td>UN and most of its specialized agencies, commonwealth, OIC, the Non-aligned movement and SAARC.</td>

                    </tr>
                    <tr>
                        <td class="td1">Religion</td>
                        <td>100% Sunni Muslim </td>

                    </tr>
                    <tr>
                        <td class="td1">Languages</td>
                        <td>Dhivehi is the national language, English is widely spoken in business sectors </td>

                    </tr>
                    <tr>
                        <td class="td1">Literacy Rate</td>
                        <td>98.2% (Age 10-45 yrs) </td>

                    </tr>
                    <tr>
                        <td class="td1">Temperature</td>
                        <td>31.1 Celsius (mean max) and 25.5 Celsius (mean min) </td>

                    </tr>
                    <tr>
                        <td class="td1">Monsoons</td>
                        <td>South-West; May-October, North-East; November-April </td>

                    </tr>
                    <tr>
                        <td class="td1">Average Daily Sunshine</td>
                        <td>8 Hours</td>

                    </tr>
                    <tr>
                        <td class="td1">Average Annual Rainfall</td>
                        <td> 1796.3mm</td>

                    </tr>
                    <tr>
                        <td class="td1">Humidity</td>
                        <td>79% </td>

                    </tr>
                    <tr>
                        <td class="td1">Currency</td>
                        <td>Maldivian Rufiyaa (1 USD = Rf 15.42) </td>

                    </tr>
                    <tr>
                        <td class="td1">Electricity</td>
                        <td> 240 VAC</td>

                    </tr>
                    <tr>
                        <td class="td1">Working hours</td>
                        <td> Banks 8.30am to 02.00 pm (Sun-Thu), Government offices 08.00am to 04.00pm, Fri & Sat holiday, Private offices 08.00am to 05.00pm</td>

                    </tr>
                    <tr>
                        <td class="td1">Credit cards</td>
                        <td>Visa, Master card, American Express, Diners Club, Eurocard, JCB </td>

                    </tr>
                    <tr>
                        <td class="td1">Major Industries</td>
                        <td>Tourism, Fisheries, Garments, Boat building and Handicrafts </td>

                    </tr>
                    <tr>
                        <td class="td1">National Tree</td>
                        <td>Coconut palm </td>

                    </tr>
                    <tr>
                        <td class="td1">National Flower</td>
                        <td>Pink Rose</td>

                    </tr>
                    <tr>
                        <td class="td1">Clothing</td>
                        <td>Light weight cottons and linens</td>
        ...
        <div class="moldives--sec2--div1">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5">
                    <img src="img/moldives/m1.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5 reverse">
                    <img src="img/moldives/m2.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5">
                    <img src="img/moldives/m3.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5 reverse">
                    <img src="img/moldives/m4.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5">
                    <img src="img/moldives/m5.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5 reverse">
                    <img src="img/moldives/m6.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5">
                    <img src="img/moldives/m7.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5 reverse">
                    <img src="img/moldives/m8.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5">
                    <img src="img/moldives/m9.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5 reverse">
                    <img src="img/moldives/m10.png" class="moldives--sec2--img1" alt="">
            ...
            <div class="moldives--sec2--div3">
                ...
                <div class="moldives--sec2--div5">
                    <img src="img/moldives/m11.png" class="moldives--sec2--img1" alt="">
